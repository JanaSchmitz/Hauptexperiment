...
public class Window extends JFrame implements ActionListener, KeyListener {
    ...
    public void createWindow() {
       ...
       // optionPane.add(CheckBoxRandomVariable);
        ...
        scrollPane.setPreferredSize(new java.awt.Dimension(1500,1010));
        ...
        buttonHilfe.setToolTipText("Erklärungen zum Programm");
        ...
        buttonStop.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int input = JOptionPane.showConfirmDialog(null, "Parameter und Daten Löschen?" + "\n" + "Daten ggf. vorher speichern", "Delete", JOptionPane.YES_NO_OPTION);
                if(input == 0) {
                    Data.clear();
                    params.clear();
        ...
        buttonAbbrechen.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Data.size() != 0) {
                    ...
                    JOptionPane.showMessageDialog(null,"Aktuelle Aufgabe abgebrochen, zum fortfahren Start drücken");
        ...
        buttonHilfe.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null,"Zu erst muss eine Datei mit den Aufgaben über den Set Parameter button geladen werden.\n" +
                        "Danach kann man über den Button Start das Experiment starten.\nDer Pseudcode wird angezeigt und das Eingabefeld wird automatisch fokusiert und die Zeitmessung gestartet \n" +
                        "Die Eingabe erfolgt als ganz zahl. Mit Enter wird die Eingabe bestätigt.\nWird das Feld unter dem eingabe Feld rot ist die Eingabe falsch.\n" +
                        "Erst bei richtiger Eingabe kann über den Start button die nächste Aufgabe generiert werden \n" +
                        "Nachdem alle Aufgaben abgearbeitet sind erscheint der Dialog keine Parameter. \nDie Daten müssen dann gespeichert werden");
