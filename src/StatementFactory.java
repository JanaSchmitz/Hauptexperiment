public class StatementFactory {
    ...
    public  void injectThrashIf(Statement parent) {
        ...
        trashIf.generateTrashif();
        parent.addChild(trashIf);
    }

    public void injectThrash(Statement parent, int lineCount){
        TRASH trash =  new TRASH(parent.getLevel()+1, "trash", "trash", "trash", parent.getMaxDepth(), parent, words, param);
        trash.generateTrash(lineCount);
